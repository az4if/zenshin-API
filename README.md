...
> [!CAUTION]
Since Render no longer provides sufficient bandwidth on free tier, the APIs will stop working for now. I am yet to find an alternative and the time to get things running again. 
